...
* [ ] T017b [US2] [NFR-002] Confirmar que el botón "Pedir pista" (T012-T013) es accesible por teclado (foco visible + activación con Enter/Espacio) y por touch/ratón, heredando el soporte nativo de `createButton` de `libs/components/button`; documentar el resultado en [quickstart.md](./quickstart.md) paso 3
