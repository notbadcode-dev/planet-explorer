...
export const DIALOG_CLOSE_TAG = 'button';
...
export const DIALOG_CLOSE_CLASS = 'dialog__close';
...
export const DIALOG_CLOSE_TYPE_ATTRIBUTE = 'type';
export const DIALOG_CLOSE_TYPE_BUTTON = 'button';
