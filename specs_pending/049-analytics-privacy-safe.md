---
id: "049-analytics-privacy-safe"
name: "Analítica de uso respetuosa con la privacidad"
phase: "Fase 7 — Calidad avanzada y escala"
depends_on: ["006-skill-progress-model", "028-parental-dashboard", "030-security-and-privacy-baseline"]
---

# 049 — Analítica de uso respetuosa con la privacidad (analytics-privacy-safe)
...
## Contexto / motivación
El principio I prohíbe mecánicas manipulativas de retención; cualquier analítica MUST NOT usarse para diseñar dichas mecánicas. Dado que el usuario principal es un niño, la privacidad es una restricción legal y ética crítica ya cubierta como línea base en 030 (security-and-privacy-baseline, Fase 4); este slice añade analítica de uso agregada respetando esa misma línea base, sin relajarla.
...
- Panel simple de visualización agregada (puede integrarse en 028 o ser interno de desarrollo, a decidir en clarificaciones).
...
## Dependencias
- 006 (fuente de datos de progreso), 028 (posible superficie de visualización), 030 (línea base de seguridad/privacidad ya auditada).
...
- Consideración transversal de privacidad de menores (ver también 030).
