...
# 019 — Reto de lectura y lenguaje (reading-challenges)
...
- Apoyo por audio (lectura en voz alta del enunciado) como requisito de accesibilidad, reutilizando el sistema de audio ya construido en 018.
- Integración con el modelo de habilidad `reading`.

## Alcance excluido
- Lectura de frases completas o comprensión lectora avanzada (ver 053, niveles avanzados).
...
## Dependencias
- 007-challenge-engine-core, 018-audio-and-sound-design (narración del enunciado).
