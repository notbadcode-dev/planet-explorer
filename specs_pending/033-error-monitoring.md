...
- Filtrado para no capturar datos personales del jugador (alineado con 030).
...
- Captura de errores específica de escenarios offline/service worker (ver 048, Fase 7 — se extiende este mismo sistema cuando exista soporte PWA, no lo bloquea).
...
- Coherencia con 030 en cuanto a no capturar datos personales de menores.
