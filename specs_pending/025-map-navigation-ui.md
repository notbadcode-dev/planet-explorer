...
depends_on: ["021-expedition-mission-structure", "024-reward-system-non-manipulative"]
---

# 025 — Mejora del mapa como interfaz central (map-navigation-ui)
...
## Contexto / motivación
El mapa inicial (004) fue mínimo, pensado para un único destino placeholder. Con la estructura de expediciones/misiones (021) y el sistema de recompensas (024) ya operativos sobre Luna y Marte, este slice formaliza el layout definitivo del mapa ANTES de escalar el contenido (Fase 5), evitando así tener que rediseñarlo por cada tanda de destinos nuevos (principio VI: diseñar lo necesario ahora, de forma que escale, sin construir por adelantado el contenido futuro en sí).
...
- Integración con el sistema de recompensas (024) para mostrar estrellas pendientes por destino.

## Alcance excluido
- Nuevos destinos reales (Juúpiter, Saturno, etc. — Fase 5, specs 037+).
- Cambios en la lógica de navegación interna (ya definida en 004).

## Dependencias
- 021, 024 (para mostrar estado de recompensas).
